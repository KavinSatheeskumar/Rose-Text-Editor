...
var $author$project$Application$main = $elm$html$Html$text('Hello, World! (Elm)');
_Platform_export({'Application':{'init':_VirtualDom_init($author$project$Application$main)(0)(0)}});}(this));
