...
var $author$project$Application$init = 0;
...
var $author$project$Application$Decrement = 1;
var $author$project$Application$Increment = 0;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('ups')
					]))
			]));
};
var $author$project$Application$main = $elm$browser$Browser$sandbox(
	{at: $author$project$Application$init, aB: $author$project$Application$update, aC: $author$project$Application$view});
